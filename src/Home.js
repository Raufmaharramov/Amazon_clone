      ...
      <div className="home">
        <div className="home__container">
          ...
          <div className="home__row">
            ...
            <Product id="487831" title="Amazon Basics 20 Pack AAA High-Performance Alkaline Batteries, 10-Year Shelf Life, Easy to Open Value Pack" image="https://m.media-amazon.com/images/I/71lNFmE8i8L._AC_SY110_.jpg" price={8.05} rating={5} />
            <Product id="487832" title="Poly (Plantronics + Polycom) Plantronics BackBeat PRO 2 Headphones - Wireless Noise Cancelling - Black Tan, Black and Tan" image="https://m.media-amazon.com/images/I/81o9tRakyBL._AC_SY200_.jpg" price={149.99} rating={5} />
          </div>
        </div>
      </div>
    </Fragment>
