...
function Payment() {
  ...
  const handleSubmit = async e => {
    // Stripe functinality
    e.preventDefault();
    // setting processing true will trigger disabled in button and it will prevent you clicking the pay button multiple times
    setProcessing(true);
        ...
        <div className="payment__section">
          ...
          <div className="payment__details">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* if there is any error with the card it will pop up */}
              {error && <div>{error}</div>}
            </form>
          </div>
        </div>
